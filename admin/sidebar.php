...
$colibriwp_info_page_support_link = \ColibriWP\Theme\Core\Hooks::colibri_apply_filters(
	'info_page_support_link',
	'https://colibriwp.com/#support'
);

$colibriwp_info_page_review_link = \ColibriWP\Theme\Core\Hooks::colibri_apply_filters(
	'info_page_review_link',
	'https://wordpress.org/support/theme/' . get_template() . '/reviews/'
);

$colibriwp_info_page_docs_link = \ColibriWP\Theme\Core\Hooks::colibri_apply_filters(
	'info_page_docs_link',
...
<div class="colibri-admin-sidebar colibri-admin-panel">
	<div class="colibri-admin-sidebar__section">
		...
		<a href="<?php echo esc_attr( $colibriwp_info_page_docs_link ); ?>" target="_blank" class="button button-primary">
	...
	<div class="colibri-admin-sidebar__section">
		...
		<a href="<?php echo esc_attr( $colibriwp_info_page_support_link ); ?>" target="_blank" class="button button-primary">
			<?php Translations::escHtmlE( 'admin_sidebar_support_action' ); ?>
		</a>
	</div>
	<div class="colibri-admin-sidebar__section">
		<div class="colibri-admin-sidebar__section__title">
			<span class="colibri-admin-sidebar__section__icon dashicons dashicons-star-filled"></span>
			<h2><?php Translations::escHtmlE( 'admin_sidebar_review_title' ); ?></h2>
		</div>
		<p class="colibri-admin-sidebar__section__description">
			<?php Translations::escHtmlE( 'admin_sidebar_review_description' ); ?>
		</p>
		<a href="<?php echo esc_attr( $colibriwp_info_page_review_link ); ?>" target="_blank" class="button button-primary">
