...
<div data-colibri-component="dropdown-menu" data-colibri-id="10-h9" class="h-menu h-global-transition-all h-ignore-global-body-typography <?php echo $component->hasOffCanvasMobile(); ?> h-menu-horizontal h-dropdown-menu style-201 style-local-10-h9 position-relative h-element <?php $component->printContainerClasses(); ?>">
  <div class="h-global-transition-all h-main-menu">
	<?php $component->printHeaderMenu(); ?>
  </div>
  <div data-colibri-id="10-h10" class="h-mobile-menu style-10 style-local-10-h10 position-relative h-element">
	<a data-click-outside="true" data-target="#offcanvas-wrapper-10-h10" data-target-id="offcanvas-wrapper-10-h10" data-offcanvas-overlay-id="offcanvas-overlay-10-h10" href="#" data-colibri-component="offcanvas" data-direction="right" data-push="false" class="h-hamburger-button">
	...
	<div id="offcanvas-wrapper-10-h10" class="h-offcanvas-panel offcanvas offcanvas-right hide force-hide style-10-offscreen style-local-10-h10-offscreen">
	  <div data-colibri-id="10-h11" class="d-flex flex-column h-offscreen-panel style-11 style-local-10-h11 position-relative h-element">
		...
		<div class="offscreen-content">
		  <div data-colibri-component="accordion-menu" data-colibri-id="10-h12" class="h-menu h-global-transition-all h-ignore-global-body-typography h-mobile-menu h-menu-accordion style-18 style-local-10-h12 position-relative h-element">
