...
class View {
	...
	public static function printIn( $wrapper, $to_print, $args = array() ) {
		...
		if ( method_exists( self::class, "{$wrapperFunctionStart}" ) ) {
			if ( method_exists( self::class, "{$wrapperFunctionEnd}" ) ) {
				call_user_func_array( array( self::class, $wrapperFunctionStart ), $args );
				call_user_func( $to_print );
				call_user_func_array( array( self::class, $wrapperFunctionEnd ), $args );
			}
		}
	}
}
