...
$colibri_theme_divider_style = array(
...
$colibri_theme_edit_this_text_in_customizer = __( 'You can edit this text in customizer', 'colibri-wp' );
$colibri_theme_action_button                = __( 'Action Button %d', 'colibri-wp' );
...
return array(
	...
	'edit_this_text_in_customizer'      => $colibri_theme_edit_this_text_in_customizer,
	'default_icon'                      => $colibri_theme_svg_icons['fort-awesome'],
	'icons'                             => $colibri_theme_svg_icons,
	'divider_style'                     => $colibri_theme_divider_style,
	'gradients'                         => array(
		'night_fade'  =>
			array(
				'name'  => 'night_fade',
	...
	'header_front_page'                 => array(
		...
		'title'        => array(
			'show'  => true,
			'value' => $colibri_theme_edit_this_text_in_customizer,
		),
		'subtitle'     => array(
			'show'  => true,
			'value' => $colibri_theme_edit_this_text_in_customizer,
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'icons' => json_encode(
					array(
						array(
							'icon'       => $colibri_theme_svg_icons['facebook'],
							'link_value' => 'http://www.facebook.com/',
							'index'      => 0,
						),
						array(
							'icon'       => $colibri_theme_svg_icons['twitter'],
							'link_value' => 'http://www.facebook.com/',
							'index'      => 1,
						),
						array(
							'icon'       => $colibri_theme_svg_icons['youtube'],
							'link_value' => 'http://www.youtube.com/',
							'index'      => 2,
						),
						array(
							'icon'       => $colibri_theme_svg_icons['vimeo'],
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => json_encode(
					array(
						array(
							'icon'       => $colibri_theme_svg_icons['map-marker'],
							'text'       => 'Location, State, Country',
							'link_value' => 'https://maps.google.com/',
							'index'      => 0,
						),
						array(
							'icon'       => $colibri_theme_svg_icons['phone-square'],
							'text'       => '(000) 123 12345',
							'link_value' => 'https://www.twitter.com/',
							'index'      => 1,
						),
						array(
							'icon'       => $colibri_theme_svg_icons['envelope'],
		...
		'button_group' => array(
			...
			'value' => json_encode(
				array(
					array(
						'label'       => sprintf( $colibri_theme_action_button, 1 ),
						'url'         => '#',
						'button_type' => '0',
						'index'       => 0,
					),
					array(
						'label'       => sprintf( $colibri_theme_action_button, 2 ),
						'url'         => '#',
						'button_type' => '1',
						'index'       => 1,
					),
